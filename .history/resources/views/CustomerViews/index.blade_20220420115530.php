			...
			<div class="col-md-8">
				...
				<div class="mb-3 d-flex justify-content-between">
					<div class="pr-3">
						...
						<a class="text-dark" href="{{ route('blog.about') }}">Nearly 200 Great Barrier Reef coral species also live in the deep sea</a>
						</h2>
						<p>
				...
				<div class="mb-3 d-flex justify-content-between">
					<div class="pr-3">
						<h2 class="mb-1 h4 font-weight-bold">
						<a class="text-dark" href="{{ route('blog.about') }}">East Antarctica's glaciers are stirring</a>
						</h2>
						<p>
				...
				<div class="mb-3 d-flex justify-content-between">
					<div class="pr-3">
						<h2 class="mb-1 h4 font-weight-bold">
						<a class="text-dark" href="{{ route('blog.about') }}">50 years ago, armadillos hinted that DNA wasn’t destiny</a>
						</h2>
						<p>
							Nasa says it has detected the first signs of significant melting in a swathe of glaciers in East Antarctica.
						</p>
