		...
		<div class="h-100 tofront">
			<div class="row justify-content-between">
				<div class="col-md-6 pt-6 pb-6 pr-6 align-self-center">
					<h3 class="display-4 secondfont mb-3 font-weight-bold">
							{{ $article->post_title; }}	
					</h3>
					<p class="mb-3"></p>
				</div>
				<div class="col-md-6 pr-0">
					<img src="{{ asset('/storage/'.$article->post_img_path) }}">
				</div>
			</div>
		</div>
	</div>
			...
			<div class="border p-5 bg-lightblue">
				<div class="row justify-content-between">
					<div class="col-md-5 mb-2 mb-md-0">
						<h5 class="font-weight-bold secondfont">Devenir un Membre</h5>
						 Obtenez les dernières nouvelles du monde entier.
						</div>
						<div class="col-md-7">
						<div class="row">
							<div class="col-md-12">
							...
							<div class="col-md-12 mt-2">
								<button type="submit" class="btn btn-success btn-block">S'abonner</button>
							</div>
						</div>
					</div>
				</div>
